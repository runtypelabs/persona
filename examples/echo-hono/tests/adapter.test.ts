...
describe("echo Hono page", () => {
  it("mounts from the IIFE global emitted by the widget build", () => {
    expect(PAGE).toContain("window.AgentWidget");
    expect(PAGE).not.toContain("window.AgentWidgetBrowser");
  });
});
