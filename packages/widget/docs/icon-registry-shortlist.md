...
| `quote` | message-actions quote button (`message-bubble.ts:860`, `messageActions.showQuote`) |
...
- **Total:** 112 (within the 90-110 target band)

All 112 names verified to exist as files under `lucide@0.552.0/dist/esm/icons/*.js`.
