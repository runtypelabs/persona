...
const SHELL_COPY_KEYS = [
  ...
  "openConversationLoadingLabel",
  "openConversationErrorTitle",
  "openConversationRetryLabel",
  "openConversationBackLabel",
  "confirmCancelLabel",
...
export const HISTORY_SHELL_COPY_DEFAULTS: ResolvedHistoryShellCopy = {
  ...
  openConversationLoadingLabel: "Loading conversation",
  openConversationErrorTitle: "Could not open the conversation.",
  openConversationRetryLabel: "Try again",
