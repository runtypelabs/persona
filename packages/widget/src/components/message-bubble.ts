...
export const createMessageActions = (
  ...
  if (showCopy) {
    const copyButton = createActionButton("copy", "Copy message", () => {
      ...
      navigator.clipboard.writeText(textToCopy).then(() => {
        ...
        copyButton.classList.add("persona-message-action-success");
        ...
        setTimeout(() => {
          copyButton.classList.remove("persona-message-action-success");
  ...
  if (showUpvote) {
    const upvoteButton = createActionButton("thumbs-up", "Upvote", () => {
      ...
      if (wasActive) {
        currentVote = null;
        upvoteButton.classList.remove("persona-message-action-active");
      } else {
        // Remove downvote if active
        const downvoteBtn = container.querySelector('[data-action="downvote"]');
        if (downvoteBtn) {
          downvoteBtn.classList.remove("persona-message-action-active");
        }
        currentVote = "upvote";
        upvoteButton.classList.add("persona-message-action-active");
  ...
  if (showDownvote) {
    const downvoteButton = createActionButton("thumbs-down", "Downvote", () => {
      ...
      if (wasActive) {
        currentVote = null;
        downvoteButton.classList.remove("persona-message-action-active");
      } else {
        // Remove upvote if active
        const upvoteBtn = container.querySelector('[data-action="upvote"]');
        if (upvoteBtn) {
          upvoteBtn.classList.remove("persona-message-action-active");
        }
        currentVote = "downvote";
        downvoteButton.classList.add("persona-message-action-active");
