...
const DEFAULT_LIGHT_PRESET: ThemeEditorPreset = {
  id: 'default-light',
  name: 'Default Light',
...
const DEFAULT_DARK_PRESET: ThemeEditorPreset = {
  id: 'default-dark',
  name: 'Default Dark',
...
export const BUILT_IN_PRESETS: ThemeEditorPreset[] = [
  {
    ...
    theme: DEFAULT_LIGHT_PRESET.theme,
    darkTheme: DEFAULT_DARK_PRESET.theme,
    preview: DEFAULT_LIGHT_PRESET.preview,
    darkPreview: DEFAULT_DARK_PRESET.preview,
