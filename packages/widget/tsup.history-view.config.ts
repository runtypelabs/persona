...
/**
 * Dedicated config for the standalone history-view chunk
 * (`dist/history-view.js`), loaded on demand by the IIFE/CDN build when the
 * visitor first opens the history ("Messages") UI. Lives in its own file
