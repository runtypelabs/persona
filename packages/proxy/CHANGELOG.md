...
- a3b2d67: Add explicit transport authority for the widget's composer selections.
...
- 78b8930: Add server-pinned agent dispatch (`agentConfig`/`agentId`) and remove the client-agent passthrough.
