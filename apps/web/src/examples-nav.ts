...
const GITHUB_REPO_URL = "https://github.com/runtypelabs/persona";

const GITHUB_MARK_SVG = `<svg viewBox="0 0 16 16" width="16" height="16" fill="currentColor" aria-hidden="true"><path d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.2-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.1.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.2 0 .21.15.46.55.38A8.013 8.013 0 0 0 16 8c0-4.42-3.58-8-8-8Z"/></svg>`;
...
export const ADVANCED_EXAMPLES: readonly AdvancedExample[] = [
  ...
  },
  {
    ...
    blurb: "ChatGPT, Claude, Gemini, Copilot, and Perplexity welcome states and composers, rebuilt with config and theme tokens only.",
    tier: "patterns",
    tags: ["interaction", "theming", "welcome", "composer"],
    modes: ["inline"],
  },
  {
    slug: "help-search-demo",
    href: "/help-search-demo.html",
    title: "Help Search",
    blurb: "A debounced help-center search card composed into the default welcome surface by a renderWelcome plugin.",
    tier: "patterns",
    tags: ["plugins", "welcome", "interaction"],
    modes: ["inline", "launcher"],
  },
  {
    slug: "pre-chat-demo",
    href: "/pre-chat-demo.html",
    title: "Pre-chat Form",
    blurb: "Gate the first turn behind an identity form, built on the renderWelcome and renderComposer hooks.",
    tier: "patterns",
    tags: ["plugins", "welcome", "forms"],
    modes: ["inline", "launcher"],
  },
  {
    slug: "home-screen-demo",
    href: "/home-screen-demo.html",
    title: "Home Screen",
    blurb: "An Intercom-style home stack with starter cards, links, and a header action that returns to it over a conversation.",
    tier: "patterns",
    tags: ["plugins", "welcome", "navigation"],
    modes: ["inline", "launcher"],
  },
  {
    slug: "history-demo",
  ...
  },
  {
    ...
    href: "/composer-actions-demo.html",
    title: "Composer Actions",
    blurb: "One action registry feeding the composer from core built-ins, host config, and two independent plugins at once.",
    tier: "patterns",
    tags: ["plugins", "composer", "interaction"],
    modes: ["inline", "launcher"],
  },
  {
    slug: "composer-suite",
    ...
    blurb: "Modes, models, overflow, send interception, locks, uploads, drafts, deferred sends, and the public composer state on one page.",
    tier: "patterns",
    tags: ["composer", "interaction", "attachments"],
    modes: ["inline", "launcher"],
  },
  {
    slug: "approval-demo",
  ...
  },
  {
    ...
    blurb: "Attach files or page context per turn with @-mentions, as removable chips or inline tokens.",
    tier: "patterns",
...
export function renderExamplesShell(
  ...
  const shellActions = `<div class="shell-actions">
    ${prevNext}
    <a class="shell-github" href="${GITHUB_REPO_URL}" target="_blank" rel="noopener" aria-label="Persona on GitHub">${GITHUB_MARK_SVG}</a>
  </div>`;
